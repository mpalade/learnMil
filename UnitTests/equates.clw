...
PAPER:B4_ISO              EQUATE(42)      ! B4 (ISO) 250 x 354 mm
PAPER:JAPANESE_POSTCARD   EQUATE(43)      ! Japanese Postcard 100 x 148 mm
PAPER:9X11                EQUATE(44)      ! 9 x 11 in
PAPER:10X11               EQUATE(45)      ! 10 x 11 in
PAPER:15X11               EQUATE(46)      ! 15 x 11 in
PAPER:ENV_INVITE          EQUATE(47)      ! Envelope Invite 220 x 220 mm
PAPER:LETTER_EXTRA        EQUATE(50)      ! Letter Extra 9 1/2 x 12 in
PAPER:LEGAL_EXTRA         EQUATE(51)      ! Legal Extra 9 1/2 x 15 in
PAPER:TABLOID_EXTRA       EQUATE(52)      ! Tabloid Extra 12 x 18 in
PAPER:A4_EXTRA            EQUATE(53)      ! A4 Extra 9.27 x 12.69 in
PAPER:LETTER_TRANSVERSE   EQUATE(54)      ! Letter Transverse 8 1/2 x 11 in
PAPER:A4_TRANSVERSE       EQUATE(55)      ! A4 Transverse 210 x 297 mm
PAPER:LETTER_EXTRA_TRANSVERSE EQUATE(56)  ! Letter Extra Transverse 9 1/2 x 12 in
PAPER:SUPER_A             EQUATE(57)      ! SuperA 227 x 356 mm
PAPER:SUPER_B             EQUATE(58)      ! SuperB 305 x 487 mm
PAPER:LETTER_PLUS         EQUATE(59)      ! Letter Plus 8 1/2 x 12.69 in
PAPER:A4_PLUS             EQUATE(60)      ! A4 Plus 210 x 330 mm
PAPER:A5_TRANSVERSE       EQUATE(61)      ! A5 Transverse 148 x 210 mm
PAPER:B5_JIS_TRANSVERSE   EQUATE(62)      ! B5 (JIS) Transverse 182 x 257 mm
PAPER:A3_EXTRA            EQUATE(63)      ! A3 Extra 322 x 445 mm
PAPER:A5_EXTRA            EQUATE(64)      ! A5 Extra 174 x 235 mm
PAPER:B5_ISO_EXTRA        EQUATE(65)      ! B5 (ISO) Extra 201 x 276 mm
PAPER:A2                  EQUATE(66)      ! A2 420 x 594 mm
PAPER:A3_TRANSVERSE       EQUATE(67)      ! A3 Transverse 297 x 420 mm
PAPER:A3_EXTRA_TRANSVERSE EQUATE(68)      ! A3 Extra Transverse 322 x 445 mm
PAPER:LAST                EQUATE(68)
...
! These equates are bitmap flags to use in the REMOVE(<string>,flags)
! statement
...
! Codes for Windows versions returned by SYSTEM {PROP:WindowsVersion,9}

WINVERSION:UNKNOWN       EQUATE(0)
WINVERSION:W95           EQUATE(1)
WINVERSION:W95OSR2       EQUATE(2)
WINVERSION:W98           EQUATE(3)
WINVERSION:W98SE         EQUATE(4)
WINVERSION:ME            EQUATE(5)
WINVERSION:NT3_5         EQUATE(6)
WINVERSION:NT4           EQUATE(7)
WINVERSION:W2000         EQUATE(8)
WINVERSION:XP            EQUATE(9)
WINVERSION:VISTA         EQUATE(10)
WINVERSION:WINDOWS7      EQUATE(11)
WINVERSION:WINDOWS8      EQUATE(12)
WINVERSION:WINDOWS8_1    EQUATE(13)
WINVERSION:WINDOWS10     EQUATE(14)

WINVERSION:SRV_NT3_5     EQUATE(1)
WINVERSION:SRV_NT4       EQUATE(2)
WINVERSION:SRV2000       EQUATE(3)
WINVERSION:HOMESERVER    EQUATE(4)
WINVERSION:SRV2003       EQUATE(5)
WINVERSION:SRV2003R2     EQUATE(6)
WINVERSION:SRV2008       EQUATE(7)
WINVERSION:SRV2008R2     EQUATE(8)
WINVERSION:SRV2012       EQUATE(9)
WINVERSION:SRV2012R2     EQUATE(10)
!WINVERSION:SRV2016      EQUATE(11)

! Codes for editions of Windows versions returned by SYSTEM {PROP:WindowsVersion,10}

WINEDITION:UNKNOWN       EQUATE(0)
WINEDITION:STARTER       EQUATE(1)
WINEDITION:HOME          EQUATE(2)
WINEDITION:HOME_BASIC    EQUATE(3)
WINEDITION:HOME_PREMIUM  EQUATE(4)
WINEDITION:STANDARD      EQUATE(5)
WINEDITION:PROFESSIONAL  EQUATE(6)
WINEDITION:BUSINESS      EQUATE(7)
WINEDITION:ULTIMATE      EQUATE(8)
WINEDITION:ENTERPRISE    EQUATE(9)
WINEDITION:ADVANCED      EQUATE(10)
WINEDITION:WEB           EQUATE(11)
WINEDITION:TABLETPC      EQUATE(12)
WINEDITION:MEDIACENTER   EQUATE(13)
WINEDITION:DATACENTER    EQUATE(14)
WINEDITION:ESSENTIAL     EQUATE(15)
WINEDITION:SMALLBUSINESS EQUATE(16)
WINEDITION:FOUNDATION    EQUATE(17)
WINEDITION:STORAGE       EQUATE(18)
